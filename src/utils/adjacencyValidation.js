 ...
 *
 * VALID_EDGES: sparse map of source -> allowed targets (798 edges across 111 sources).
...
const VALID_EDGES = {
    ...
    "3dBandpass": ["3dNetCorr", "3dRSFC", "3dTcorr1D", "3dTcorrMap"],
    ...
    "3dUndump": ["3dNwarpApply", "3dNwarpCat", "3dTstat", "3dcalc", "ImageMath", "ThresholdImage", "antsApplyTransforms", "applywarp", "cluster", "convertwarp", "fslmaths", "fslmeants", "fslroi", "fslstats", "invwarp"],
    ...
    "3dfractionize": ["3dNwarpApply", "3dNwarpCat", "3dTstat", "3dcalc", "ImageMath", "ThresholdImage", "antsApplyTransforms", "applywarp", "cluster", "convertwarp", "fslmaths", "fslmeants", "fslroi", "fslstats", "invwarp"],
    ...
    "3dmerge": ["3dAutomask"],
    "3dresample": ["3dNwarpApply", "3dNwarpCat", "3dTstat", "3dcalc", "ImageMath", "ThresholdImage", "antsApplyTransforms", "applywarp", "cluster", "convertwarp", "fslmaths", "fslmeants", "fslroi", "fslstats", "invwarp"],
    ...
    "LabelGeometryMeasures": ["3dNwarpApply", "3dNwarpCat", "3dTstat", "3dUndump", "3dcalc", "3dfractionize", "3dresample", "ImageMath", "ThresholdImage", "antsApplyTransforms", "applywarp", "cluster", "convertwarp", "fslmaths", "fslmeants", "fslroi", "fslstats", "invwarp", "whereami"],
    ...
    "antsBrainExtraction.sh": ["Atropos", "antsAtroposN4.sh", "antsRegistration", "antsRegistrationSyN.sh", "antsRegistrationSyNQuick.sh", "fast", "run_first_all"],
    "antsIntermodalityIntrasubject.sh": ["antsIntermodalityIntrasubject.sh"],
    "antsJointLabelFusion.sh": ["3dNwarpApply", "3dNwarpCat", "3dTstat", "3dUndump", "3dcalc", "3dfractionize", "3dresample", "ImageMath", "ThresholdImage", "antsApplyTransforms", "applywarp", "cluster", "convertwarp", "fslmaths", "fslmeants", "fslroi", "fslstats", "invwarp", "whereami"],
    "antsMotionCorr": ["3dDespike", "dual_regression", "melodic"],
    "applytopup": ["3dvolreg", "antsMotionCorr", "mcflirt"],
    ...
    "dual_regression": ["film_gls", "flameo", "randomise"],
    ...
    "fsl_prepare_fieldmap": ["3dvolreg", "antsMotionCorr", "mcflirt"],
    ...
    "mri_convert": ["3dNwarpApply", "3dNwarpCat", "3dTcat", "3dTstat", "3dUndump", "3dZeropad", "3dcalc", "3dcopy", "3dfractionize", "3dinfo", "3dresample", "ImageMath", "LabelGeometryMeasures", "ThresholdImage", "antsApplyTransforms", "antsJointLabelFusion.sh", "applywarp", "cluster", "convertwarp", "fslmaths", "fslmeants", "fslmerge", "fslreorient2std", "fslroi", "fslsplit", "fslstats", "invwarp", "robustfov", "whereami"],
    ...
    "prelude": ["3dvolreg", "antsMotionCorr", "mcflirt"],
    ...
    "topup": ["3dvolreg", "amico_noddi", "antsMotionCorr", "bedpostx", "dmri_postreg", "dtifit", "dwi2fod", "dwi2tensor", "mcflirt", "tensor2metric"],
    ...
    "whereami": ["3dNwarpApply", "3dNwarpCat", "3dTstat", "3dcalc", "ImageMath", "ThresholdImage", "antsApplyTransforms", "applywarp", "cluster", "convertwarp", "fslmaths", "fslmeants", "fslroi", "fslstats", "invwarp"]
};
