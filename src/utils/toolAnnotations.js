/**
 * Tool annotations: metadata that supplements CWL definitions.
 *
 ...
 *
 * Initially auto-generated by scripts/generateAnnotations.mjs — then manually maintained.
 */
...
export const TOOL_ANNOTATIONS = {
    ...
    feat: {
        ...
        modality:
            'FEAT design file (.fsf) encoding all analysis parameters including input data paths, preprocessing options, design matrix, and contrasts.',
        keyParameters:
        ...
        typicalUse:
            'Complete first-level or higher-level fMRI analysis when all parameters are pre-configured in an FSF file.',
        inputExtensions: {
            design_file: ['.fsf'],
        },
        outputExtensions: {},
    ...
    'antsRegistrationSyNQuick.sh': {
        ...
        function:
            'Fast SyN registration with reduced iterations and coarser sampling for rapid approximate registration.',
        modality: 'Any 3D NIfTI volume pair.',
    ...
    eddy: {
        ...
        modality:
            '4D diffusion-weighted NIfTI with b-values (.bval), b-vectors (.bvec), acquisition parameters, and index files.',
        keyParameters:
    ...
    bedpostx: {
        ...
        modality:
            'Directory containing 4D DWI (data.nii.gz), b-values (bvals), b-vectors (bvecs), and brain mask (nodif_brain_mask.nii.gz).',
    ...
    'recon-all': {
        ...
        typicalUse:
            'Complete cortical reconstruction for surface-based morphometry, parcellation-based analysis, and as prerequisite for fMRI surface analysis.',
        inputExtensions: {
    ...
    fsl_regfilt: {
        ...
        typicalUse:
            'Removing ICA-identified noise components from fMRI data, often used with FIX or manual classification.',
        inputExtensions: {
            input: ['.nii', '.nii.gz'],
            design: ['.txt', '.mat'],
        },
    ...
    dcm2niix: {
        ...
        typicalUse:
            'First step in any neuroimaging pipeline: converting raw DICOM acquisitions to analysis-ready NIfTI.',
        inputExtensions: {},
        outputExtensions: {
...
export const dummyNodes = {
    'I/O': [
        ...
        },
        {
            ...
            function:
                'Represents the final output of the workflow. Click the Outputs button to select which upstream outputs appear in the final CWL workflow.',
            typicalUse:
                'Connect from the last processing step, then click Outputs to configure which outputs appear in the final workflow',
            isDummy: true,
            isOutputNode: true,
        },
        {
            ...
            typicalUse:
                'Drag onto canvas, select your BIDS directory, choose subjects and modalities, then wire outputs to processing tools',
            isDummy: true,
            isBIDS: true,
        },
    ],
...
export const modalityDescriptions = {
    ...
    Multimodal:
        'Cross-modality analysis pipelines. Tools that integrate structural, functional, and diffusion data for comprehensive brain mapping.',
    Utilities:
...
/**
 * Builder function: resolves tool names to annotation references.
 */
